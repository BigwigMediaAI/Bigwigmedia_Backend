...
router.post('/generateBlogPost',upload.single('image'),generateBlogPost);
...
router.post('/convertsvgtojpg', upload.single('svg'), convertSvgToJpeg);
router.post("/convertsvgtopng",upload.single('image'),svgtopngconverter)
