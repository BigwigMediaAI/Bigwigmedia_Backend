...
router.post('/GenerateFreestyleEmail',GenerateFreestyleEmail);
router.post('/GenerateEmailGenerator',GenerateEmailGenerator);
router.post('/GenerateEmailReply',GenerateEmailReply);
