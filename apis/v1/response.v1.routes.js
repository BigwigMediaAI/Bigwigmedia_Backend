...
router.post('/generateFacebookPageDescription', generateFacebookPageDescription);
router.post('/generateYouTubePostTitle', generateYouTubePostTitle);
router.post('/generateYouTubePostDescription', generateYouTubePostDescription);
